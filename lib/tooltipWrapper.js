...
var TooltipWrapper = function TooltipWrapper(props) {
  ...
  (0, _react.useEffect)(function () {
    setDomNode(document.getElementById("".concat(tooltipId, "-tooltip-wrapper")));
  }, []);
  ...
  var renderToolTip = function renderToolTip() {
    ...
    return _reactDom.default.createPortal(_react.default.createElement(_tooltip.default, {
      ...
      placement: placement,
      onTooltipMouseOver: showTooltip,
      onTooltipMouseLeave: hideTooltip
    }), domNode);
  };

  return _react.default.createElement("span", {
    key: "".concat(tooltipId, "-tooltip-wrapper"),
    id: "".concat(tooltipId, "-tooltip-wrapper"),
