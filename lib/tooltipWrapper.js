...
var TooltipWrapper = function TooltipWrapper(props) {
  ...
  var domNode = document.getElementById(idProp);
  ...
  var renderToolTip = function renderToolTip() {
    ...
    var _sourceRef$current$ge = sourceRef.current.getBoundingClientRect(),
        left = _sourceRef$current$ge.left,
        top = _sourceRef$current$ge.top,
        width = _sourceRef$current$ge.width;
  ...
  var tooltipWrapper = function tooltipWrapper() {
    return _react.default.createElement("span", {
      ...
      tabIndex: "0",
      role: "button",
      "aria-describedby": "".concat(idProp, "-content")
    }, children);
  };
